...
<div class="min-h-screen flex relative overflow-hidden">
    <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center bg-mesh-dark">
        ...
        <div class="absolute top-32 right-20 w-2 h-2 rounded-full animate-float" style="background: #34d399; box-shadow: 0 0 15px rgba(52,211,153,0.4);"></div>
        <div class="absolute bottom-28 left-20 w-1.5 h-1.5 rounded-full animate-float" style="background: #10b981; box-shadow: 0 0 12px rgba(16,185,129,0.4); animation-delay: 1.5s;"></div>
            ...
            <div class="mt-12 space-y-4 text-left max-w-sm mx-auto pt-8" style="border-top: 1px solid rgba(255,255,255,0.06);">
                ...
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style="background: rgba(16,185,129,0.1);">
                        <i class="fas {{ $b['icon'] }} text-sm" style="color: #10b981;"></i>
                    </div>
                    <p class="text-sm text-secondary-300">{{ $b['text'] }}</p>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center py-16 px-6 bg-secondary-50">
        <div class="w-full max-w-md">
            ...
            <p class="text-center mt-6 text-sm text-secondary-500">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="font-bold" style="color: #059669;">Masuk di sini</a>
            </p>
        </div>
    </div>
</div>
