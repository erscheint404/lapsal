...
<div class="min-h-screen flex relative overflow-hidden">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center bg-mesh-dark">
        ...
        <div class="absolute bottom-40 right-20 w-1.5 h-1.5 rounded-full animate-float" style="background: #00e5ff; box-shadow: 0 0 12px rgba(0,229,255,0.4); animation-delay: 1s;"></div>
        <div class="absolute top-[60%] left-[30%] w-1 h-1 rounded-full animate-float-slow" style="background: #ccff00; box-shadow: 0 0 10px rgba(204,255,0,0.3); animation-delay: 2s;"></div>
        ...
        <div class="relative z-10 text-center px-16 max-w-lg">
            ...
            <p class="text-dark-300 text-lg leading-relaxed">Platform booking lapangan futsal terpercaya. Main lebih mudah, jadwal lebih pasti.</p>
            ...
            <div class="mt-12 grid grid-cols-3 gap-6 pt-8" style="border-top: 1px solid rgba(255,255,255,0.06);">
                <div>
                    ...
                    <p class="text-xs text-dark-400 mt-1">Booking Online</p>
                </div>
                <div>
                    <p class="text-2xl font-display font-black text-white">100+</p>
                    <p class="text-xs text-dark-400 mt-1">Member Aktif</p>
                </div>
                <div>
                    <p class="text-2xl font-display font-black text-white">4.9</p>
                    <p class="text-xs text-dark-400 mt-1">Rating</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="w-full max-w-md">
            <div class="text-center mb-8 lg:text-left">
                <div class="w-14 h-14 rounded-2xl flex items-center justify-center mb-5 lg:mx-0 mx-auto"
                     style="background: linear-gradient(135deg, #ccff00, #a3cc00); box-shadow: 0 4px 20px rgba(204,255,0,0.25);">
                    <i class="fas fa-sign-in-alt text-dark-950 text-xl"></i>
                </div>
                <h1 class="text-3xl font-display font-bold text-dark-900 tracking-tight">Masuk ke Akun</h1>
                <p class="text-dark-500 mt-2">Masukkan kredensial Anda untuk melanjutkan</p>
            </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="checkbox" name="remember" class="w-4 h-4 rounded-lg border-dark-300 transition-colors" style="accent-color: #ccff00;">
                            <span class="text-sm font-medium text-dark-600 group-hover:text-dark-800">Ingat saya</span>
                        </label>
                        <a href="{{ route('password.request') }}" class="text-sm font-semibold transition-colors" style="color: #6e8f00;" onmouseover="this.style.color='#526b00'" onmouseout="this.style.color='#6e8f00'">Lupa password?</a>
                    </div>
            ...
            <p class="text-center mt-6 text-sm text-dark-500">
                Belum punya akun?
                <a href="{{ route('register') }}" class="font-bold" style="color: #6e8f00;">Daftar sekarang</a>
            </p>
        </div>
    </div>
</div>
